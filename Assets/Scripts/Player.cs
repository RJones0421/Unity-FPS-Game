...
public class Player : NetworkBehaviour
{
    ...
    //Modified RigidbodyFirstPersonController.cs script
    ...
    private void FixedUpdate()
    {
        ...
        if ((Mathf.Abs(input.x) > float.Epsilon || Mathf.Abs(input.y) > float.Epsilon) && (advancedSettings.airControl || m_IsGrounded))
        {
            ...
            Vector3 desiredMove = virtualCamera.transform.forward * input.y + virtualCamera.transform.right * input.x;
    ...
    private void RotateView()
    {
        ...
        mouseLook.LookRotation(transform, virtualCamera.transform, m_LookAxis);
    ...
    public class MouseLook
    {
        ...
        [Client]
        public void LookRotation(Transform character, Transform camera, Vector2 lookAxis)
        {
